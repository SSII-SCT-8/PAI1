# Script de demostración para Windows PowerShell
# Ejecuta el servidor y el cliente en ventanas separadas

Write-Host ""
Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host " PAI1 - Sistema de Verificación de Integridad" -ForegroundColor Cyan
...
Write-Host "1. Inicializando base de datos con usuarios de prueba..." -ForegroundColor Yellow
python "$BASE_DIR\config\seed_database.py"

Write-Host ""
Write-Host "2. Iniciando SERVIDOR en nueva ventana..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "3. Iniciando CLIENTE en nueva ventana..." -ForegroundColor Yellow
...
Write-Host "  1. En la ventana del CLIENTE, use opción 2 para hacer LOGIN" -ForegroundColor White
Write-Host "  2. Pruebe enviar transacciones (opción 3)" -ForegroundColor White
