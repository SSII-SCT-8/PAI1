...
from ..common.crypto import derive_user_key, verify_password
from ..common.errors import AuthenticationError, UserAlreadyExistsError
...
class MessageHandler:
    ...
    def handle_register(
        self, username: str, payload: Dict[str, Any], client_ip: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Usuario '{username}' registrado exitosamente desde {client_ip}"
            )
    ...
    def handle_login(
        ...
        try:
            ...
            return {
                "success": False,
                "message": str(e)
                if isinstance(e, (AuthenticationError, Exception))
                else "Error interno",
            }
    ...
    def handle_transaction(
        ...
        try:
            ...
            return {"success": False, "message": "Error procesando transacción"}

    def handle_logout(self, username: str, payload: Dict[str, Any]) -> Dict[str, Any]:
