...
from ..common.protocol import send_message, receive_message, canonicalize_message
from ..common.crypto import generate_nonce, compute_hmac, derive_user_key
...
class ClientAPI:
    ...
    def register(self, username: str, password: str) -> Dict[str, Any]:
        ...
        msg = self._create_message(
            "REGISTER", username, {"password": password}, use_mac=False
        )
    ...
    def login(self, username: str, password: str) -> Dict[str, Any]:
        ...
        self.user_key, self.user_key_salt = derive_user_key(MASTER_KEY_BYTES, username)
    ...
    def send_transaction(
        self, from_account: str, to_account: str, amount: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.get("success"):
                logger.info(
                    f"Transacción enviada: {from_account} -> {to_account}: {amount}"
                )
    ...
    def logout(self) -> Dict[str, Any]:
        ...
        msg = self._create_message(
            "LOGOUT", self.username, {"session_id": self.session_id}
        )
    ...
    def send_replay_attack(
        ...
        try:
            ...
            logger.warning(
                "⚠️  SIMULACIÓN DE ATAQUE: Reenviando mismo mensaje (REPLAY)..."
            )
            send_message(self.sock, msg)
    ...
    def send_mitm_attack(
        self, from_account: str, to_account: str, amount: str, tampered_amount: str
    ) -> Dict[str, Any]:
